package com.example.userservice.user_microservice.aspects;
...
public class LoggingAspect {
    @Before("execution( * com.example.userservice.user_microservice.controllers.*.getData(..))")
    public void beforeGetData(JoinPoint joinPoint) {
        System.out.println("before fetching data : " + joinPoint.getSignature());
    }

    @After("execution( * com.example.userservice.user_microservice.*.getData(..))")
    public void AfterGetData(JoinPoint joinPoint) {
        System.out.println("after fetching data : " + joinPoint.getSignature());
    }

    @AfterReturning(pointcut = "execution( * com.example.userservice.user_microservice.controllers*.getData(..))", returning = "result")
    ...
    @After("within(com.example.userservice.user_microservice.controllers*)")
    ...
    @Around("within(com.example.userservice.user_microservice.controllers.*)")
